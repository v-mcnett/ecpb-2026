    ...
    <footer className="footer footer-center p-10 bg-base-200 text-base-content">
      ...
      <div>
        ...
        <div className="grid grid-flow-col gap-4">
          ...
          <a href="https://facebook.com/emeraldcityphotobooth" className="link link-hover " target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://instagram.com/emeraldcityphotobooth" className="link link-hover" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://pinterest.com/emeraldcitywed" className="link link-hover" target="_blank" rel="noopener noreferrer">
